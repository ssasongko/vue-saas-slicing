<template>
  <section class="w-full flex flex-col gap-y-6">
    <div class="flex justify-space-between gap-5">
      <p
      ...
      <div class="flex items-start w-full flex-wrap gap-2 text-sm">
        ...
        <div
          ...
          class="flex rounded-3xl text-virindian-primary bg-powerblue-primary py-2 px-4 gap-2 items-center"
        >
          <p class="text-sm cursor-default">
      ...
      <div class="flex shrink-0 items-center gap-2">
        ...
        >
          ...
          >
            <img class="w-8" src="/images/icons/IconGrid.svg" />
          </button>
          <button
          ...
          >
            <img class="w-8" src="/images/icons/IconList.svg" />
          </button>
        </div>
      </div>
    </div>
    <div class="flex shadow-primary h-auto relative border">
      <input v-model="search.fieldtext" type="text" placeholder="Search here"
        class="w-full p-4 rounded-md border-0 text-[#B4CAD8]" />
      <div class="absolute right-4 top-4 cursor-pointer">
        <img src="/images/icons/IconSearch.svg" alt="" />
      </div>
    </div>
  </section>
</template>
